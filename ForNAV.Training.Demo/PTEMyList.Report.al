...
Report 70630 "PTE My List"
{
	...
	begin
		...
		CurrReport.Language(ReportForNav.GetLanguageID(id));
#if GE_BC_23_0_0_0
		FormatRegion := ReportForNav.GetFormatRegion(CurrReport.FormatRegion());
		if FormatRegion <> '' then
			CurrReport.FormatRegion(FormatRegion);
#endif
