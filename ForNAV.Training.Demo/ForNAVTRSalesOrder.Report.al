...
Report 70630 "ForNAV TR Sales Order"
{
    ...
    WordLayout = './Layouts/ForNAVSalesOrder.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem("Red Ink Text"; "Red Ink Text")
            {
                ...
                trigger OnPreDataItem();
                begin
                    "Red Ink Text".SetView(ReportForNav.OnPreDataItemView('RedInkText', "Red Ink Text"));
                end;
        ...
        case (dataItemId) of
            ...
            'ForNAVTRTable':
                begin
                    ...
                    GlobalLanguage := 1033;
                    jsonObject.Add('DataItem$ForNAVTRTable$CurrentKey$Text', "ForNAV TR Table".CurrentKey);
            ...
            'RedInkText':
                begin
                    currLanguage := GlobalLanguage;
                    GlobalLanguage := 1033;
                    jsonObject.Add('DataItem$RedInkText$CurrentKey$Text', "Red Ink Text".CurrentKey);
                    GlobalLanguage := currLanguage;
                end;
        end;
